...
const socialLinks = [
  ...
  },
  {
    name: 'Instagram',
    Icon: Instagram,
    url: '#', // Replace with actual Instagram profile URL
    qrCode: '/qr/instagram_qr.png', // Placeholder path
  },
  {
    name: 'Facebook',
    Icon: Facebook,
    url: 'https://www.facebook.com/profile.php?id=100013277046735', // From HTML
    qrCode: '/qr/facebookqr.webp', // Placeholder path
  },
  {
    name: 'Twitter',
    Icon: Twitter,
    url: '#', // Replace with actual Twitter profile URL
    ...
    <footer className="bg-gray-100 dark:bg-gray-800 py-8 mt-16">
      <div className="container mx-auto px-4 text-center md:flex md:justify-between md:items-center">
        <p className="text-gray-600 dark:text-gray-400 mb-4 md:mb-0">
          Copyright &copy; {new Date().getFullYear()} Francis Dugbe
        </p>
