...
const portfolioItems = [
  {
    id: 1,
    title: 'Crafted High-Converting Copy',
    description: 'I wrote persuasive content for websites, landing pages, emails, and ads that guided readers toward specific actions, leading to higher engagement and conversion rates.',
    imageUrl: '/portfolio/copywriting.jpg', // Placeholder path - Put actual images in /public/portfolio/
    tags: ['copywriting', 'marketing'],
  },
  {
    id: 2,
    title: 'Collaborated with Designers and Developers',
    description: 'I worked closely with creative and tech teams to ensure that visual elements supported the copy, creating a seamless and impactful user experience.',
    imageUrl: '/portfolio/collabration.jpg', // Placeholder path
    tags: ['collaboration', 'teamwork', 'ux'],
  },
  {
    id: 3,
...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio" className="py-16 md:py-24 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-4 text-center">
        <p className="text-blue-600 dark:text-blue-400 font-semibold mb-2">What I Did?</p>
