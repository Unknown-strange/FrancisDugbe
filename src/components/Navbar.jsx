...
const Navbar = () => {
    ...
    return (
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 shadow-md px-4 py-3 transition-colors duration-300">
        <div className="container mx-auto flex justify-between items-center">
          <a href="#home" className="text-xl font-bold text-gray-800 dark:text-white">Francis Dugbe</a>
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 shadow-md px-4 py-3 transition-colors duration-300">
      ...
      <div
        id="mobile-menu"
        className={`md:hidden absolute top-full left-0 right-0 bg-white dark:bg-gray-900 shadow-lg transition-transform transform duration-300 ease-in-out ${isOpen ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0 pointer-events-none'}`}
      >
